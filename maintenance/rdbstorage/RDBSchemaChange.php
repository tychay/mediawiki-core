...
class RDBSchemaChange extends Maintenance {
	public function __construct() {
		...
		$this->mDescription = "Prepare or run a schema change on all shards table for a wiki";
	}
	...
	protected function generateSQL() {
		...
		$rdbStore = RDBStoreGroup::getExternal( $this->getOption( 'store' ) );
